---
title: GraphHopper 快速搭建测试教程
date: 2020-03-27 14:15:19
categories: GEO
tags:
  - GEO
  - Software
...
* Geofabrik 下载页面 [点我](https://download.geofabrik.de/asia/china.html)
* china-latest.osm.pbf 地址 [点我](https://download.geofabrik.de/asia/china-latest.osm.pbf)


# 准备 GraphHopper

* GraphHopper Github [点我](https://github.com/graphhopper/graphhopper)
* graphhopper-web-0.13.0.jar 下载地址 [点我](https://graphhopper.com/public/releases/graphhopper-web-0.13.0.jar)
...
```
java -Xmx4g -Xms4g -Dgraphhopper.datareader.file=china-latest.osm.pbf -jar graphhopper-web-0.13.0.jar server config-example.yml
```
